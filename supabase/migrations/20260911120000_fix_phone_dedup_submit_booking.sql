-- Migration: Fix phone deduplication in submit_public_booking
-- Canonical DDD matching ensures numbers with country code 55 (e.g. 555189741970 from WhatsApp bot)
-- match web bookings (e.g. 51989741970 or (51) 98974-1970) without creating duplicates in public.clients.
...
BEGIN
  ...
  -- Canonical DDD extraction for matching
  v_ddd := CASE
  ...
  -- Identificação inteligente de cliente existente por telefone
